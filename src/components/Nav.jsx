...
const Nav = ({ landing }) => {
            ...
            icon: (
                <svg
                    ...
                    <g fill="none" fillRule="evenodd">
                        ...
                        <path
                            fill="currentColor"
                            d="M2 10.5a8.5 8.5 0 1 1 15.176 5.262l3.652 3.652a1 1 0 0 1-1.414 1.414l-3.652-3.652A8.5 8.5 0 0 1 2 10.5ZM10.5 6a1 1 0 0 0 0 2a2.5 2.5 0 0 1 2.5 2.5a1 1 0 1 0 2 0A4.5 4.5 0 0 0 10.5 6Z"
                        />
                    </g>
                </svg>
            ),
    ...
    return (
        !landing && (
            <nav className="fixed bottom-4 left-1/2 -translate-x-1/2 py-3 px-5 bg-black bg-opacity-70 text-white backdrop-blur-md rounded-2xl z-[999] ">
