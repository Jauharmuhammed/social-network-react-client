...
const Reply = ({ reply, setReplies, setReplyTo, commentRef }) => {
    ...
    const [deleteReplyOverlay, setDeleteReplyOverlay] = useState(false);
    ...
    useEffect(() => {
        ...
        reply?.user === user?.user_id && setDeletable(true);
    }, [reply]);
        ...
        <li className="pl-10 flex gap-2">
            ...
            <div className="flex-col">
                ...
                <div className="flex gap-3">
                    ...
                    <span onClick={handleLike} className="cursor-pointer flex gap-1 items-center">
                        {liked ? (
                    ...
                    {deletable && (
                        <span
                            onClick={() => setDeleteReplyOverlay(true)}
                            className="text-gray-400 text-sm cursor-pointer">
                            Delete
                        </span>
                    )}
                    <DeleteReplyModal
                        ...
                        deleteReplyOverlay={deleteReplyOverlay}
                        setDeleteReplyOverlay={setDeleteReplyOverlay}
                    />
                </div>
            </div>
        </li>
