...
const LandingPage = () => {
  ...
  return (
    <>
    { !user && <Layout setLoginOverlay={setLoginOverlay} setSignupOverlay={setSignupOverlay} >
      <div className="flex justify-center text-white ">
        <div className="flex flex-col items-start">
          ...
          <h4 onClick={()=> setSignupOverlay(true)} className="signupNow mt-2 text-xl font-medium text-yellow cursor-pointer">Signup Now</h4>
        </div>
      </div>
      ...
      <LoginModal setLoginOverlay={setLoginOverlay} loginOverlay={loginOverlay} setSignupOverlay={setSignupOverlay} />
      {/* <LoginModal signup setSignupOverlay={setSignupOverlay} signupOverlay={signupOverlay} setLoginOverlay={setLoginOverlay} /> */}
      <SignupModal setSignupOverlay={setSignupOverlay} signupOverlay={signupOverlay} setLoginOverlay={setLoginOverlay}/>
    </Layout>}
    </>
  );
};
